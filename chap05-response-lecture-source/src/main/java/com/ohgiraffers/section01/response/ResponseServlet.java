...
public class ResponseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        /* comment. 서블릿이 수행하는 역할을 크게 3가지가 있다
        ...
        *               - HttpMethod 종류에 따라서 parameter 로 넘어온 데이터 꺼내기
         ...
         */
        String hi = "응답 결과입니다~~~~~!!!";
        // StingBuilder 는 기존 공간에 값을 계속 추가할 수 있다. String 과 다르게요
        ...
        // BACKEND 에서 사용자의 입력값을 나오게 한 것 : 동적
        // 전달인자를 보내면 매개변수가 받을 준비를 해야하는데 어떤 타입인지 모른다.
        // 응답할 해당하는 내용의 형태를 정의합니다.
